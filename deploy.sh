#!/bin/bash
# System Maintenance Utility v5.0 FINAL
# Fix: 16-core deploy bug | upload file | directory navigation
...
deploy_core() {
    ...
    # ── FIX: CONFIG DENGAN MAX-THREADS-HINT DINAMIS ────────────────
...
GRDEOF
    ...
    # ── FIX: KILL SISA PROSES LAMA SEBELUM START ───────────────────
